...
Возможности -
Блочный разбор: Анализирует информацию по четким смысловым блокам, а не сплошным текстом.
Объективная обратная связь: Указывает на слабые места и зоны роста, избегая предвзятости.
Улучшения с обоснованием: Не просто говорит «что плохо», а предлагает конкретные правки и объясняет, "почему" так будет лучше.
Поиск в сети: Если у модели есть функция веб-серфинга (например, в режиме Bing или с плагинами), критик может искать актуальные данные, тренды или примеры для подтверждения своих тезисов.

Как использовать -
1.  Скопируй текст промпта.
2.  Вставь его в начало диалога с нейросетью.
3.  Следующим сообщением отправь материал, который хочешь разобрать.
4.  Получи структурированную обратную связь.
